...
public class Hospital extends AppCompatActivity {
    ...
    private void prepareContent() {
        ...
        ArrayList<HospitalObj> hospitalObj = (ArrayList<HospitalObj>) hospitalViewModel.getAlls();
        recyclerView = (RecyclerView) findViewById(R.id.hospitalRecyclerView);

        HospitalAdapter adapterRecycle = new HospitalAdapter(this, hospitalObj);
